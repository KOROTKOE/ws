...
class PassengerController extends Controller
{
    public function takePlace(PlaceRequest $request, $code)
    {
        ...
        else$id = $booking->flight_back;
        $bookingsFrom = Booking::where('flight_from',$id)->where('date_from', $booking->date_from)->get();
        $bookingsBack = Booking::where('flight_back',$id)->where('date_back', $booking->date_back)->get();
