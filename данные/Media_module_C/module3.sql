...
--
-- Хост: 127.0.0.1:3306
-- Время изменения: Янв 10 2021 г., 20:44
...
INSERT INTO `stations` (`id`, `city`, `name`, `iata`, `created_at`, `updated_at`) VALUES
(1, 'Cheboksary', 'Cheboksary Bus station', 'CSY', NULL, NULL),
(2, 'Kazan', 'Kazan', 'KZN', NULL, NULL),
(3, 'Samara', 'Samara Bus station', 'SMR', NULL, NULL),
(4, 'Astrahan', 'Astrahan Bus station', 'AST', NULL, NULL);
...
(1, 1, 'TestCase1_first_name', 'TestCase1_last_name', '1990-02-20', '7788223311', '7A', NULL, '2020-04-15 14:53:44', '2020-04-15 14:53:44'),
(2, 1, 'TestCase2_first_name', 'TestCase2_last_name', '1992-09-22', '9922335577', NULL, '8B', '2020-04-15 14:53:44', '2020-04-15 14:53:44');
...
--
ALTER TABLE `flights`
  ADD CONSTRAINT `flights_from_id_foreign` FOREIGN KEY (`from_id`) REFERENCES `stations` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `flights_to_id_foreign` FOREIGN KEY (`to_id`) REFERENCES `stations` (`id`) ON DELETE CASCADE;
